...
<div style="width:100%">
        ...
        <div style="margin:auto; padding:20px;  background-color:rgb(0, 0, 0);">
                ...
                <p style="font-family:'IBM Plex Sans',Arial,sans-serif;font-size:20px;line-height:1.25;color:#ffffff;font-weight:600;padding:0px;text-align:center">Congratulations!!! Your Account Registration was successful.</p>
         </div>
         <div bgcolor="#ffffff" align="left" style="padding:30px">
                <p style="font-family:'IBM Plex Sans',Arial,sans-serif;color:#333333;font-size:14px;font-weight:400;line-height:1.5;margin:10px 0px 0px">Your login email: {{ $user['email'] }}.</p>
                <p style="font-family:'IBM Plex Sans',Arial,sans-serif;color:#333333;font-size:14px;font-weight:400;line-height:1.5;margin:10px 0px 0px">Your login username: {{ $user['username'] }}.</p>
