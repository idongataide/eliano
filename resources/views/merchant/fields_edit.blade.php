...
<div class="form-group">
    {!! Form::label('name', 'Merchant Number:',['class' => 'col-sm-3 control-label']) !!}
    <div class="col-sm-8">
    ...
    <div class="col-sm-8">
            <select class="form-control" id="marital_status_id" name="marital_status_id">
                ...
                @foreach ($marital_status as $row)
                    <option  {{ ($row->id == $user->marital_status_id)? 'selected':'' }} value="{{ $row->id }}">{{ $row->name }}</option>
                @endforeach
          </select>
    </div>
</div>
    ...
    <div class="col-sm-8">
            <select class="form-control" id="legal_status_id" name="legal_status_id">
                ...
                @foreach ($legal_status as $row)
                    <option  {{ ($row->id == $user->legal_status_id)? 'selected':'' }} value="{{ $row->id }}">{{ $row->name }}</option>
                @endforeach
          </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8 col-xs-12">
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-calendar text-primary"></i></span>
            <input type="text" class="form-control datepicker" name="date_issued" value="{{ $user->date_issued }}" >
        </div>
        <span class="help-block"></span>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8 col-xs-12">
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-calendar text-primary"></i></span>
            <input type="text" class="form-control datepicker" name="date_of_expiry" value="{{ $user->date_of_expiry }}" >
        </div>
        <span class="help-block"></span>
    </div>
</div>
...
<div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
    <div class="col-sm-3"></div>    
        <div class="col-sm-8">
            <input type="checkbox" class="custom-control-input" name="pep" id="pep" {{$user->pep == "1" ? 'checked' : '' }}>
...
<div class="form-group">
    ...
    <div class="col-sm-8 col-xs-12">
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-calendar text-primary"></i></span>
            <input type="text" class="form-control datepicker" name="kin_dob" value="{{ $user->kin_dob }}" >
        </div>
        <span class="help-block"></span>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
            <select class="form-control" id="kin_gender" name="kin_gender">
                <option value="">Choose gender...</option>
                @foreach ($gender as $row)
                    <option  {{ ($row->id == $user->kin_gender)? 'selected':'' }} value="{{ $row->id }}">{{ $row->name }}</option>
                @endforeach
          </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
            <select class="form-control" id="gar_gender" name="gar_gender">
                <option value="">Choose gender...</option>
                @foreach ($gender as $row)
                    <option  {{ ($row->id == $user->gar_gender)? 'selected':'' }} value="{{ $row->id }}">{{ $row->name }}</option>
                @endforeach
          </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8 col-xs-12">
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-calendar text-primary"></i></span>
            <input type="text" class="form-control datepicker" name="gar_date_issued" value="{{ $user->gar_date_issued }}" >
        </div>
        <span class="help-block"></span>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8 col-xs-12">
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-calendar text-primary"></i></span>
            <input type="text" class="form-control datepicker" name="gar_date_expiry" value="{{ $user->gar_date_expiry }}" >
        </div>
        <span class="help-block"></span>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8 col-xs-12">
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-calendar text-primary"></i></span>
            <input type="text" class="form-control datepicker" name="gar_date_signed" value="{{ $user->gar_date_signed }}" >
        </div>
        <span class="help-block"></span>
    </div>
</div>
